...
//     <>
//       <motion.div
//         className={`fixed top-6 right-[1px] max-w-xs z-50
...
//       >
//         <div className="relative py-3 rounded-full bg-zinc-800/80 backdrop-blur-md border border-zinc-700/50 shadow-lg ">
